...
* Using [axibase_nginx_plus_collector](./axibase-nginx-plus-collector/src) python script along with an OS scheduler. This way is described at [axibase_nginx_plus_collector page](./axibase-nginx-plus-collector).
