...
| Delete Files on Upload   | **Applies to FILE protocol**. Delete source file(s) that were parsed into at least one command which was successfully sent to the database. |
