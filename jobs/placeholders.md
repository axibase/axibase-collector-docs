...
The `TIME` function calculates time based on the [calendar](https://github.com/axibase/atsd/blob/master/shared/calendar.md) expression. The syntax outputs value in the specified `time_format`.
