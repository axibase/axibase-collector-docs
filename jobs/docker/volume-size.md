...
---|---
`docker.fs.size.rw` | The total size of all the files in the container, in bytes. The entire filesystem of the container exported in tarbell form is about this size.
