...
`docker.fs.size.rw` | File System | The total size of all the files in the container, in bytes. If you were to export the filesystem of the container in tarball form, the file would be about that size.
